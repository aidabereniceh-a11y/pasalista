    ...
    <main style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0a0f1e 0%, #1e1b4b 100%)", fontFamily: "Arial, sans-serif", padding: "24px", color: "white" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "32px", flexWrap: "wrap", gap: "16px" }}>
          ...
          <button onClick={exportarExcel} style={{ background: "linear-gradient(135deg, #166534, #15803d)", color: "white", border: "1px solid rgba(34,197,94,0.3)", padding: "10px 20px", borderRadius: "10px", fontSize: "13px", fontWeight: "600", cursor: "pointer", marginRight: "10px" }}>Exportar Excel (hoy)</button>
        ...
        <p style={{ color: "#64748b", fontSize: "12px", margin: "-24px 0 24px 0" }}>
          ℹ️ "Exportar Excel (hoy)" solo guarda la asistencia de hoy con fecha y hora. Para descargar varios días, entra a "📊 Ver reporte".
        </p>
